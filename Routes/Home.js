...
import Animated, { interpolate, useAnimatedStyle, useSharedValue, useAnimatedScrollHandler, useAnimatedGestureHandler, withTiming, withSpring, runOnJS } from "react-native-reanimated"
...
const Home = () => {
  ...
  const ballStyle = useAnimatedStyle(() => {
    ...
    return {
      ...
      transform: [{translateX: withSpring(touchX.value, SPRING_CONFIG)},{translateY: withSpring(touchY.value, SPRING_CONFIG)}, {scale: interpolate(scroll.value,[-50,0,500],[0.9,1,1.6])}]
    }
  })
  ...
  return (
    <View style={styles.container}>
      <Animated.ScrollView onScroll={scrollHandler} scrollEventThrottle={16} style={[{height: "100%", width: "100%"},scrollStyle]} contentContainerStyle={{ height: "200%", justifyContent: "center", alignItems: "center"}}>
      </Animated.ScrollView>
